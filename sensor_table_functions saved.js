  ...
  module.exports = {
    ...
    runSQL:function (client,req,res,mssh){
       ...
       sqlstatement = getQParam(req,"sqlstatement")==null ? "" : getQParam(req,"sqlstatement");
    ...
    runSQLForAPICommands:function(client, req, res, mssh, paramName,dataSource,dataSourceField,callingModuleName){
      ...
      var pVal = getQParam(req,paramName);
    ...
    var shelfID = getQParam(req,"shelfID")==null ? "" : getQParam(req,"shelfID");                 
...
////////////////                        
    ...
    insertRecords: function (tablename,client, req,res) {
    	...
    	try{
          //fields is a stringified JSONObject
           var fieldsAndValues = getQParam(req,"fields");
    ...
    multiInsertRecords: function (tablename,client, req,res) {
      var fvMap = JSON.parse(getQParam(req,"fields")).recs 
    ...
    updateFacingMerchandiseData:function(client,req,res,mssh){
      ...
      /* Begin transaction */
      var shelfID = getQParam(req,"shelfID");
      var startPosition = getQParam(req,"startposition");
      var endPosition = getQParam(req,"endposition");
      var fromDate = getQParam(req,"fromdate");


      //var merchandiseItemID = req.param("merchandiseitemid");
      var productID = getQParam(req,"productid");
    ...
    insertFacings:function(client,req,res,mssh){
      ...
      var facing   = JSON.parse(getQParam(req,"facing"));
      var shelfPosition = facing.shelfRelativeAddress;
      var nFacings = getQParam(req,"numberoffacings");
    ...
    getInventoryOverTime:function(client,req,res,mssh){
       ...
       var returnintervalsonly = getQParam(req,"returnintervalsonly");
       ...
       var searchterms   = getQParam(req,"searchterms");
       if (searchterms){
       ...
       var startdate     = getQParam(req,"startdate");
       var enddate       = getQParam(req,"enddate");
       var inthrs        = getQParam(req,"inthrs");
       var intmins       = getQParam(req,"intmins");
    ...
    getSensorDataOverTimeNOTUSED:function(client,req,res,mssh){
       ...
       var whereClause   = " where ";
       var orderbyClause = " order by "
       var searchterms   = JSON.parse(getQParam(req,"searchterms"));
       var startdate     = rgetQParam(req,"startdate");
       var enddate       = getQParam(req,"enddate");
       var didloop=false;
...
function getQParam(req,paramName){
